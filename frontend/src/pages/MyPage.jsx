    ...
    <div className="mx-auto max-w-7xl px-4 py-16 md:py-24">
      ...
      <div className="rounded-2xl bg-slate-900/60 p-6 ring-1 ring-white/10 mt-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button onClick={() => handleDownload('pdf')} className="flex-1 px-4 py-3 bg-cyan-400 text-slate-900 rounded-lg font-semibold hover:bg-cyan-300 transition duration-200">PDF로 내보내기</button>
        </div>
      </div>
    </div>
  );
